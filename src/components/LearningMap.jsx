...
const FLOW = ['전자', '이온', '산성', '항산화', '생체분자', '광합성', '산화', '금속/부식']
        ...
        {MODULES.map((m, i) => {
          ...
          return (
            <button
              ...
              className={`relative border rounded-2xl p-4 text-left transition-all hover:scale-[1.03] hover:shadow-lg group ${cls}`}
            >
              {isDone && (
