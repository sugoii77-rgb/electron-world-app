...
const MODULE_ORDER = ['home','map','module1','module2','module3','module4','module5','module6','module7','module8','module9','module10','module11','quiz','summary']
const MODULE_PAGES = ['module1','module2','module3','module4','module5','module6','module7','module8','module9','module10','module11']
...
export default function App() {
  ...
  const navigate = (dest) => { setPage(dest); window.scrollTo(0, 0) }
  ...
  return (
    <div className="min-h-screen bg-[#0a0a1a] text-slate-100">
      {page !== 'home' && (
        <NavBar currentPage={page} completed={completed} navigate={navigate}
          analogyMode={analogyMode} setAnalogyMode={setAnalogyMode} progress={progressPct} />
      )}
      <main>
        ...
        {page === 'module11' && <Module11 {...sharedProps} />}
